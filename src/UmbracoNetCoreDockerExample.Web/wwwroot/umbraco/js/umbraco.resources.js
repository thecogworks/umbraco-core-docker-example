 ...
 */
     ...
     */
            getPasswordConfig: function getPasswordConfig(userId) {
                return umbRequestHelper.resourcePromise($http.get(umbRequestHelper.getApiUrl('authenticationApiBaseUrl', 'GetPasswordConfig', { userId: userId })), 'Failed to retrieve membership provider config');
            },
            /**
     * @ngdoc method
    ...
    function currentUserResource($q, $http, umbRequestHelper, umbDataFormatter) {
      ...
      */
            ...
            getCurrentUserLinkedLogins: function getCurrentUserLinkedLogins() {
                return umbRequestHelper.resourcePromise($http.get(umbRequestHelper.getApiUrl('currentUserApiBaseUrl', 'GetCurrentUserLinkedLogins')), 'Server call failed for getting current users linked logins');
            },
